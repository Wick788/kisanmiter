export const mockMachineryData = [
  {
    ...
    reviews: [
      { farmerName: "Suresh Singh", rating: 5, comment: "Excellent tractor! Very powerful and fuel efficient.", date: "2026-04-15" },
      { farmerName: "Amit Patel", rating: 4, comment: "Good condition, helped me complete my work on time.", date: "2026-03-22" }
    ],
  ...
  },
  {
    ...
    pricePerDay: 2200,
    providerEmail: "demo.provider@kisanmiter.com",
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Ramesh Kumar", rating: 5, comment: "Perfect for sugarcane fields. Highly recommended!", date: "2026-04-10" },
      { farmerName: "Gopal Sharma", rating: 4, comment: "Good tractor with adequate power.", date: "2026-03-05" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Krishna Rao", rating: 5, comment: "Outstanding tractor! Very smooth operation.", date: "2026-04-20" },
      { farmerName: "Naresh Babu", rating: 5, comment: "Best tractor for paddy fields.", date: "2026-04-05" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Baljeet Singh", rating: 4, comment: "Reliable and economical tractor.", date: "2026-03-28" },
      { farmerName: "Kuldeep Kaur", rating: 5, comment: "Perfect for my small farm.", date: "2026-03-15" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Gurpreet Singh", rating: 5, comment: "Harvested my entire 50-acre field in 2 days!", date: "2026-04-18" },
      { farmerName: "Manjeet Kaur", rating: 5, comment: "Excellent machine, saved me a lot of time and labor.", date: "2026-04-01" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Santosh Patil", rating: 5, comment: "Perfect for my vegetable farm. Very easy to operate.", date: "2026-09-12" },
      { farmerName: "Ramesh Jadhav", rating: 4, comment: "Compact and powerful. Good for small farms.", date: "2026-08-25" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Vijay Kumar", rating: 5, comment: "Front loader is very useful for loading operations.", date: "2026-09-08" },
      { farmerName: "Rajesh Sharma", rating: 4, comment: "Good tractor with useful attachments.", date: "2026-08-20" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Mahesh Kumar", rating: 4, comment: "Economical and reliable tractor.", date: "2026-08-30" },
      { farmerName: "Dinesh Choudhary", rating: 4, comment: "Good value for money.", date: "2026-08-10" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Balwinder Singh", rating: 5, comment: "Very powerful tractor for tilling work.", date: "2026-09-14" },
      { farmerName: "Paramjeet Kaur", rating: 4, comment: "Good tractor with strong engine.", date: "2026-08-28" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Shyam Lal", rating: 4, comment: "Reliable and fuel-efficient tractor.", date: "2026-08-18" },
      { farmerName: "Hari Om", rating: 5, comment: "Perfect for my small farm needs.", date: "2026-08-05" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Amarjeet Singh", rating: 5, comment: "Excellent harvester! Very efficient.", date: "2026-09-16" },
      { farmerName: "Harbhajan Singh", rating: 5, comment: "Best harvester I've used.", date: "2026-09-03" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Surinder Pal", rating: 5, comment: "Excellent soil preparation. Very effective.", date: "2026-09-11" },
      { farmerName: "Davinder Singh", rating: 4, comment: "Good quality rotavator.", date: "2026-08-22" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Mukesh Kumar", rating: 4, comment: "Good threshing efficiency.", date: "2026-08-25" },
      { farmerName: "Rakesh Sharma", rating: 5, comment: "Very useful machine for post-harvest.", date: "2026-08-12" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Dilip Patel", rating: 5, comment: "Perfect seed placement. Excellent germination.", date: "2026-09-07" },
      { farmerName: "Anand Singh", rating: 4, comment: "Good seed drill with consistent performance.", date: "2026-08-19" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Jayesh Shah", rating: 4, comment: "Good for supplemental irrigation.", date: "2026-08-28" },
      { farmerName: "Mehul Desai", rating: 5, comment: "Excellent coverage and water distribution.", date: "2026-08-15" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Lakhbir Singh", rating: 4, comment: "Strong trolley for heavy loads.", date: "2026-08-20" },
      { farmerName: "Gurdev Singh", rating: 4, comment: "Good capacity and reliable.", date: "2026-08-08" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Satpal Singh", rating: 5, comment: "Excellent precision leveling. Worth every penny!", date: "2026-09-13" },
      { farmerName: "Manjeet Rana", rating: 5, comment: "Amazing results! Field is perfectly level.", date: "2026-08-29" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Jagtar Singh", rating: 4, comment: "Very useful for fencing work.", date: "2026-08-24" },
      { farmerName: "Randhir Singh", rating: 5, comment: "Saves a lot of manual labor.", date: "2026-08-11" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Ravi Kumar", rating: 5, comment: "Perfect for my vegetable garden.", date: "2026-09-09" },
      { farmerName: "Srinivas Rao", rating: 4, comment: "Easy to operate and very effective.", date: "2026-08-26" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Anil Jadhav", rating: 5, comment: "Excellent coverage. Saves time and chemicals.", date: "2026-09-06" },
      { farmerName: "Sachin Patil", rating: 4, comment: "Good sprayer with uniform application.", date: "2026-08-23" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Virendra Kumar", rating: 5, comment: "Perfect for potato planting. Very precise.", date: "2026-09-04" },
      { farmerName: "Rajesh Tyagi", rating: 4, comment: "Good machine with consistent spacing.", date: "2026-08-21" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Charan Singh", rating: 5, comment: "Excellent machine for sugarcane harvesting.", date: "2026-09-02" },
      { farmerName: "Mohan Lal", rating: 4, comment: "Good harvester, saves a lot of labor.", date: "2026-08-17" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Selvam Kumar", rating: 5, comment: "Excellent transplanter. Very efficient.", date: "2026-09-10" },
      { farmerName: "Kannan Raju", rating: 5, comment: "Best machine for paddy planting.", date: "2026-08-27" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Pratap Singh", rating: 4, comment: "Good chaff cutter for livestock feed.", date: "2026-08-22" },
      { farmerName: "Bhim Singh", rating: 5, comment: "Very useful for dairy farming.", date: "2026-08-09" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Kuldip Singh", rating: 5, comment: "Excellent baling. Very efficient.", date: "2026-09-05" },
      { farmerName: "Simranjeet Kaur", rating: 4, comment: "Good quality bales. Reliable machine.", date: "2026-08-18" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Dinesh Sharma", rating: 4, comment: "Good plough for hard soil.", date: "2026-08-25" },
      { farmerName: "Arvind Kumar", rating: 5, comment: "Excellent penetration and soil turning.", date: "2026-08-12" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Kishore Shah", rating: 4, comment: "Good for secondary tillage operations.", date: "2026-08-20" },
      { farmerName: "Nilesh Patel", rating: 4, comment: "Effective weed control.", date: "2026-08-07" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Vinod Deshmukh", rating: 5, comment: "Perfect for orchard spraying.", date: "2026-09-08" },
      { farmerName: "Ajay Raut", rating: 4, comment: "Good pressure and coverage.", date: "2026-08-24" }
    ],
    createdAt: "2026-01-20T10:00:00Z"
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Deepak Malik", rating: 5, comment: "Excellent for zero-till farming. Highly recommend!", date: "2026-09-12" },
      { farmerName: "Rohit Sharma", rating: 5, comment: "Saves time and resources. Great machine.", date: "2026-08-28" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Subba Rao", rating: 4, comment: "Essential for paddy field operations.", date: "2026-08-19" },
      { farmerName: "Venu Gopal", rating: 5, comment: "Great traction in muddy fields.", date: "2026-08-06" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Naveen Kumar", rating: 5, comment: "Amazing technology! Very precise spraying.", date: "2026-09-15" },
      { farmerName: "Prasad Gowda", rating: 5, comment: "Perfect for hilly terrain. Excellent investment.", date: "2026-09-01" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Hanuman Ram", rating: 5, comment: "Excellent solution for remote fields. No electricity needed!", date: "2026-09-11" },
      { farmerName: "Kishan Lal", rating: 4, comment: "Good pump with reliable solar system.", date: "2026-08-26" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Maruti Kale", rating: 5, comment: "Very hygienic and efficient milking.", date: "2026-09-07" },
      { farmerName: "Sharad More", rating: 4, comment: "Good machine for dairy operations.", date: "2026-08-21" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Vijay Rawat", rating: 4, comment: "Good for clearing tough vegetation.", date: "2026-08-23" },
      { farmerName: "Ashok Negi", rating: 5, comment: "Powerful and easy to use.", date: "2026-08-10" }
    ],
  ...
  },
  {
    ...
    status: "available" as const,
    reviews: [
      { farmerName: "Gurpreet Singh", rating: 5, comment: "Complete solution for all my needs. Great value!", date: "2026-09-03" },
      { farmerName: "Harjeet Kaur", rating: 4, comment: "Good quality attachments. Well-maintained.", date: "2026-08-16" }
    ],
