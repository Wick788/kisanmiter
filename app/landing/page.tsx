  ...
  const testimonials = [
    {
      ...
      avatar: "👨‍🌾",
      quote: "KisanMiter helped me identify wheat rust early and saved my entire crop. The treatment recommendations were spot-on!",
      rating: 5,
    },
    {
      name: "Priya Sharma",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-green-900">KisanMiter</span>
            </div>
          ...
          >
            <div className="space-y-3 lg:space-y-4">
              ...
              <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
                ...
                Join thousands of farmers who are already improving their yields with KisanMiter.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-gray-900 mb-4">
              Discover What's New in KisanMiter
            </h2>
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600">
              See how KisanMiter is transforming agriculture for thousands of farmers
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                KisanMiter combines cutting-edge AI technology with deep agricultural expertise to provide 
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-green-100 leading-relaxed max-w-2xl mx-auto">
              Join thousands of farmers who are already using KisanMiter to improve their yields, 
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold">KisanMiter</span>
              </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 KisanMiter. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
