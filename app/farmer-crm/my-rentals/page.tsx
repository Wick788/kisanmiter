              ...
              <>
                ...
                <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-6 mb-8">
                  ...
                  <div className="space-y-3 text-sm text-gray-700">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p><strong>Dispute Resolution:</strong> Any disputes arising from this agreement shall be resolved through the KisanMiter platform's resolution mechanism.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-2 border-gray-300 rounded-lg p-6 mb-6 bg-white">
                  ...
                  <div className="mt-6 pt-6 border-t-2 border-dashed border-gray-300 bg-amber-50 p-4 rounded">
                    <p className="text-xs text-center text-gray-700">
                      ...
                      This agreement is legally binding and has been digitally signed by both parties using the KisanMiter secure authentication system.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t-4 border-double border-gray-400 text-center space-y-3">
                  ...
                  <p className="text-sm font-semibold text-gray-800">
                    This is a digitally generated certificate from KisanMiter Digital Agriculture Platform
                  </p>
                  ...
                  <div className="text-xs text-muted-foreground space-y-1 pt-3">
                    <p>KisanMiter™ - Empowering Indian Agriculture</p>
